...
```js
console.log(numA + numB); //Uncaught ReferenceError: Cannot access 'numA' before initialization
let numA = 21,
  numB = 30;
```
...
sayHello(); //VM207:3 Uncaught ReferenceError: Cannot access 'username' before initialization
```
